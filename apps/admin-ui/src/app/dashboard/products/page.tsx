...
const fetchProducts = async () => {
  ...
  //console.log("GET /get-shop-products response:", res.data);
  ...
  return (
    <div className="w-full min-h-screen p-8">
      <div className="flex justify-between items-center mb-1">
        <h2 className="text-2x text-white font-semibold">All Products</h2>
        <Link
          href="/dashboard/create-product"
          className=" @bg-blue-600 hover: bg-blue-70 text-white px-4 py-2 rounded-lg">
