  ...
  return (
    <div className="w-full min-h-screen p-8">
      <div className="flex justify-between items-center mb-1">
        ...
        <button className=" @bg-blue-600hover: bg-blue-700 text-white px-4 py-2 rounded=lg flex items-center gap-2"
      ...
      <div className="mt-8 bg-gray-900 p-6 rounded-lg shadow-lg">
          ...
          <table className="w-full text-white">
            ...
            <tbody >
              {discountCodes?.map((discount: any) => (
                <tr key={discount?.id} className="border-b border-gray-800 hover:bg-gray-600 transition">
                  ...
                  <td className="p-3">
                    <button
                      onClick={() => handleDeleteClick(discount)} className="text-red-400 hover:text-red-400 transition">
                      <Trash size={18} />
        ...
        {!isLoading && discountCodes?.length === 0 && (
          <p className="text-gray-400 text-center pt-4 block">No discount Codes Available</p>
        )}
      </div>
      ...
      {showModal && (
        <div className="fixed top-0 left-0 w-full h-full bg-black flex bg-opacity-50 items-center justify-center">
          <div className="bg-gray-800 p-6 rounded-lg w-[450px] shadow-lg">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="mt-4">
              <Input
                type="text" // Assuming you intended to specify a type
                label="Title(Public Name)"
                {...register("public_name", { // <-- Corrected structure
              ...
              <div className="mt-2">
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <select
                      {...field}
                      className="w-full border outline-none border-gray-700 bg-transparent p-2 rounded-lg" // Added missing background and padding/styling
                    >
