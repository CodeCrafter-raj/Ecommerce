...
const GoogleButton = () => {
  return (
    <div className='w-full flex justify-center'>
      {/* Container for the button. The 'items-center gap-2' ensures the icon and text are centered and spaced. */}
      <div 
        ...
        style={{ width: 'fit-content' }} // Optional: Makes the button only as wide as its content
      >
        ...
        <svg
          ...
          y="0px"
          viewBox="0 0 512 512"
          // 💡 FIX: Explicitly set the width and height of the SVG.
          // A size like 20x20px or 24x24px is standard for small icons.
          width="24px" 
          height="24px"
        >
          {/* Note: I'm keeping the original complex SVG paths for demonstration, 
             but typically a Google sign-in button uses a simpler, standard icon. */}
          <circle
            style={{ fill: "#273B7A" }}
            cx={256}
            cy={256}
